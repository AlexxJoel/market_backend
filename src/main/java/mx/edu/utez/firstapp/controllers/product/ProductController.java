...
public class ProductController {
    ...
    @GetMapping("/")
    public ResponseEntity<CustomResponse<List<Product>>> getAll() throws IOException {
    ...
    public ResponseEntity<CustomResponse<Object>> insert(@Valid @RequestBody ProductDto product){
        return new ResponseEntity<>(this.service.insert(product.cast()),HttpStatus.CREATED);
    }
}
